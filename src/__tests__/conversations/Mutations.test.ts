...
// npm test -- src/__tests__/conversations/Mutations.test.ts
...
describe('Conversation Mutations', () => {
  ...
  describe('startConversation', () => {
    ...
    it('should adjust token budget if actual usage exceeds estimate', async () => {
      ...
      await conversationsMutation.startConversation(
        null,
        { content: 'Hi' },  // Very short = low estimate
        ctx
      );
    ...
    it('should not throw error when post-call adjustment exceeds budget', async () => {
      ...
      const result = await conversationsMutation.startConversation(
        null,
        { content: 'Test' },
        ctx
      );
